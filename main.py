...
def build_prompt(query: str, context: List[str]) -> List[ChatCompletionMessageParam]:
    ...
    system: ChatCompletionMessageParam = {
        "role": "system",
        "content": "I am going to ask you question, that I would like you to answer. I am going to provide you github discussions."
        "Answer the question only based on the provided discussions, and not any other information."
        "If there is not enough information in the context to answer the question,"
        'say "I am not sure", then try to make a guess.'
        "Break your answer up into nicely readable paragraphs. Also recommend some solutions.",
    }
